...
<!--             <input type="text" class="form-control" placeholder="Search..." />
        ...
        <ul class="nav navbar-nav side-bar">       
          ...
          <li class="side-bar">
              <a href="/BugerKingW/ProductManager?service=pm">
              <span class="glyphicon glyphicon-folder-open">&nbsp;</span>Product manage</a>
          </li>
          ...
          <li class="side-bar main-menu">
            <a href="/BugerKingW/CustomerManager?service=cm">
              <span class="glyphicon glyphicon-th-list">&nbsp;</span>Customer manage</a>
          </li>
